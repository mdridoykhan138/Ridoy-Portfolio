  ...
  return (
    <Link href={href} className="group" target="_blank">
        <div className="w-full h-[300px] p-8 rounded-[30px] flex items-center justify-center mb-6 relative overflow-hidden bg-[#f4f4f4]">
            ...
            <Image src={img} alt="" fill priority quality={100} className="object-cover group-hover:scale-105 transition-all duration-500"/>
        </div>
        <div className="flex items-center justify-center">
            <div className="flex-1">
                <h3 className="h3">{title}</h3>
            </div>
            <button className="bg-accent text-white rounded-full w-[40px] h-[40px] flex items-center justify-center -rotate-45 group-hover:rotate-0 transition-all">
