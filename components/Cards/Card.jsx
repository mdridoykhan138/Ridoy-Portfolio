...
const Card = ({
  ...
  return (
    <div className="w-full h-[400px] overflow-hidden flex items-center sticky top-12">
        <div className="w-full h-[370px] border border-accent/80 bg-[#f4ffff] rounded-[8px]">
            <div className="flex flex-col h-full">
                ...
                <div className="flex flex-1 items-center justify-center xl:justify-stretch md:py-8 md:px-16">
